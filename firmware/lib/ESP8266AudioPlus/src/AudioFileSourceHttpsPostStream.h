...
class AudioFileSourceHttpsPostStream : public AudioFileSource
{
  friend class AudioFileSourceICYStream;

  public:
    AudioFileSourceHttpsPostStream();
    AudioFileSourceHttpsPostStream(const char *url, const char* root_ca);
    virtual ~AudioFileSourceHttpsPostStream() override;
